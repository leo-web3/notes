...
![eth_sign screenshot](https://github.com/ethereum/EIPs/blob/master/assets/eip-712/eth_sign.png)
...
![eth_signTypedData screenshot](https://github.com/ethereum/EIPs/blob/master/assets/eip-712/eth_signTypedData.png)
